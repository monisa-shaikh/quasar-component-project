<template>
  <q-page>
    ...
    <!-- End first card for Basic-->

  

    <!-- Second card for Styling-->
    <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
          <div class="text-h6">Styling</div>
        ...
        <q-card-section>
          ...
          <!-- End Code for Styling-->
        </q-card-section>

        <q-separator dark />
      </q-card>
    </div>
    <!-- End Second card for Styling -->

    <!-- <h5 class="text-blue-5 q-mb-sm">With icon</h5> -->

    <!-- third card for Positioning-->

    <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
          <div class="text-h6">Positioning</div>
    ...
    <!-- End third for Positioning -->


    <!-- fourth card Maximized-->
    ...
    <!-- End fourth Maximized -->



    <!-- Five card for Various content-->
       <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
          <div class="text-h6">Various content</div>
         
        </q-card-section>

        <q-card-section>
          <!-- Code for Various content-->
       <div class="q-pa-md q-gutter-sm">
    ...
    <q-dialog v-model="sliders">
      <q-card style="width: 300px" class="q-px-sm q-pb-md">
        ...
        <q-item dense>
          ...
          <!-- End Code for Various content-->
        </q-card-section>

        <q-separator dark />
      </q-card>
    </div>
    <!-- End Five card for Various content-->

    <!-- six card for With containerized QLayout -->
      <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
          <div class="text-h6">With containerized QLayout</div>
        ...
        <q-card-section>
          ...
          <!-- End Code for Indeterminate state-->
        </q-card-section>

        <q-separator dark />
      </q-card>
    </div>
    <!-- End six card for Indeterminate state-->


    <!-- seven card for Scrollable dialogs-->
    <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
          <div class="text-h6">Scrollable dialogs</div>
         
        </q-card-section>

        <q-card-section>
          <!-- Code for Scrollable dialogs-->
            <div class="q-pa-md q-gutter-sm">
          ...
          <!-- End Code for Scrollable dialogs-->
        </q-card-section>

        <q-separator dark />
      </q-card>
    </div>
    <!-- ----------End seven card for Scrollable dialogs--------------- -->


        <!-- Eight card for Persistent-->
    <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
        ...
        <div class="q-pa-md q-gutter-sm">
          ...
          <!-- End Code for Persistent-->
        </q-card-section>

        <q-separator dark />
      </q-card>
    </div>
    <!-- ----------End Eight card for Persistent--------------- -->


    
        <!-- Nine card for Seamless-->
    <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
          <div class="text-h6">Seamless</div>
    ...
    <q-dialog v-model="seamless" seamless position="bottom">
      <q-card style="width: 350px">
        ...
        <q-card-section class="row items-center no-wrap">
          ...
          <!-- End Code for Seamless-->
        </q-card-section>

        <q-separator dark />
      </q-card>
    </div>
    <!-- ----------End Nine card for Seamless--------------- -->



    
    
        <!----------- Ten card for Inception-------------->
    <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
        ...
        <div class="q-pa-md q-gutter-sm">
          ...
          <!-- End Code for Inception-->
        </q-card-section>

        <q-separator dark />
      </q-card>
    </div>
    <!-- ----------End Ten card for Inception--------------- -->

 
        <!----------- eleven card for Sizing-------------->
    <div class="row items-start q-mt-md">
      <q-card class="my-card text-gray" v-if="isshowprop">
        <q-card-section class="row">
          <div class="text-h6">Sizing</div>
